...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/level.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		className.set ("assets/images/map2.png", __ASSET__assets_images_map2_png);
		type.set ("assets/images/map2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/player-l.png", __ASSET__assets_images_player_l_png);
		type.set ("assets/images/player-l.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("images/enemy1.png", __ASSET__images_enemy1_png);
		type.set ("images/enemy1.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("images/fireball.png", __ASSET__images_fireball_png);
		type.set ("images/fireball.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("images/map.png", __ASSET__images_map_png);
		type.set ("images/map.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("images/map2.png", __ASSET__images_map2_png);
		type.set ("images/map2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("images/player-l.png", __ASSET__images_player_l_png);
		type.set ("images/player-l.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("images/player.png", __ASSET__images_player_png);
		type.set ("images/player.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("sounds/sounds-go-here.txt", __ASSET__sounds_sounds_go_here_txt);
		type.set ("sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("music/music-goes-here.txt", __ASSET__music_music_goes_here_txt);
		type.set ("music/music-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("data/level.csv", __ASSET__data_level_csv);
		type.set ("data/level.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		type.set ("assets/images/map2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/player-l.png", "assets/images/player-l.png");
		type.set ("assets/images/player-l.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		type.set ("assets/sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("images/enemy1.png", "images/enemy1.png");
		type.set ("images/enemy1.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/fireball.png", "images/fireball.png");
		type.set ("images/fireball.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/map.png", "images/map.png");
		type.set ("images/map.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/map2.png", "images/map2.png");
		type.set ("images/map2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/player-l.png", "images/player-l.png");
		type.set ("images/player-l.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/player.png", "images/player.png");
		type.set ("images/player.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("images/tiles.png", "images/tiles.png");
		type.set ("images/tiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("sounds/sounds-go-here.txt", "sounds/sounds-go-here.txt");
		type.set ("sounds/sounds-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("music/music-goes-here.txt", "music/music-goes-here.txt");
		type.set ("music/music-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("data/level.csv", "data/level.csv");
		type.set ("data/level.csv", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__assets_data_level_csv extends flash.utils.ByteArray { }
class __ASSET__assets_images_enemy1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_fireball_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_map_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_map2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_player_l_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class __ASSET__images_enemy1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_fireball_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_map_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_map2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_player_l_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_player_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__images_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__sounds_sounds_go_here_txt extends flash.utils.ByteArray { }
class __ASSET__music_music_goes_here_txt extends flash.utils.ByteArray { }
class __ASSET__data_level_csv extends flash.utils.ByteArray { }
